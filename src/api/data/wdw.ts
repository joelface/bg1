...
export default {
  ...
  experiences: {
    ...
    '80010110': { name: 'Big Thunder Mountain Railroad', priority: 5 },
    '80010114': { name: "Buzz Lightyear's Space Ranger Spin", priority: 11 },
    '80010129': { name: 'Dumbo the Flying Elephant' },
    '17718925': { name: 'Festival of Fantasy Parade' },
    '80010208': { name: 'Haunted Mansion', priority: 7 },
    '80010149': { name: "it's a small world", priority: 10 },
    '80010153': { name: 'Jungle Cruise', priority: 2 },
    '80010162': { name: 'Mad Tea Party' },
    '80010210': { name: 'Magic Carpets of Aladdin' },
    '80010213': { name: 'Many Adventures of Winnie the Pooh', priority: 9 },
    '80010170': { name: "Mickey's PhilharMagic" },
    '136550': { name: 'Monsters Inc. Laugh Floor' },
    '80010176': { name: "Peter Pan's Flight", priority: 3 },
    '80010177': { name: 'Pirates of the Caribbean', priority: 8 },
    ...
    '16767284': { name: 'Seven Dwarfs Mine Train', priority: 1 },
    '80010190': { name: 'Space Mountain', priority: 4 },
    '80010192': { name: 'Splash Mountain', priority: 6 },
    '80010222': { name: 'Tomorrowland Speedway' },
    '16767263': { name: 'Under the Sea' },
    // Epcot
    '18269694': { name: 'Disney & Pixar Short Film Festival' },
    '18375495': { name: 'Frozen Ever After', priority: 3 },
    '80010152': { name: 'Journey Into Imagination' },
    '80010161': { name: 'Living with the Land' },
    '80010173': { name: 'Mission: SPACE', priority: 5 },
    '19497835': { name: "Remy's Ratatouille Adventure", priority: 1 },
    '107785': { name: 'Seas with Nemo & Friends' },
    '20194': { name: "Soarin' Around the World", priority: 4 },
    '80010191': { name: 'Spaceship Earth', priority: 6 },
    '80010199': { name: 'Test Track', priority: 2 },
    '62992': { name: 'Turtle Talk With Crush' },
    // Hollywood Studios
    '18904172': { name: 'Alien Swirling Saucers', priority: 8 },
    ...
    '19259335': { name: "Mickey & Minnie's Runaway Railway", priority: 6 },
    '19263735': { name: 'Millennium Falcon: Smugglers Run', priority: 3 },
    '80010151': { name: 'Muppet*Vision 3D' },
    '80010182': { name: "Rock 'n' Roller Coaster", priority: 5 },
    '18368386': { name: 'Meet Disney Stars @ Red Carpet Dreams' },
    '18368385': { name: 'Meet Olaf @ Celebrity Spotlight' },
    '18904138': { name: 'Slinky Dog Dash', priority: 2 },
    '80010193': { name: 'Star Tours', priority: 9 },
    '19263736': { name: 'Rise of the Resistance', priority: 1 },
    '209857': { name: 'Toy Story Mania', priority: 7 },
    '80010218': { name: 'Twilight Zone Tower of Terror', priority: 4 },
    // Animal Kingdom
    '19330300': { name: 'Animation Experience' },
    '18665186': { name: 'Avatar Flight of Passage', priority: 1 },
    '80010123': { name: 'DINOSAUR', priority: 4 },
    '26068': { name: 'Expedition Everest', priority: 5 },
